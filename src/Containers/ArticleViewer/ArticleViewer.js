...
const ArticleViewer = ({match: {params}}) => {
    ...
    return (
        <div className={'bg-patek-light-green position-relative'}>
                ...
                <Row>
                    <Col>
                        <div className="text-center pt-lg-5 mt-lg-5 ">
                            <div className="px-2 py-2 text-white d-inline-block ls-0-5 fs-0-7 text-uppercase bg-black w-150px">News</div>
                            <HeaderText className='fs-lg-2 mb-lg-5' text={'Corn Harvest Only 30% Complete,USDA says and so does EFCC'}/>
                            <img src={image} className='article-header-image' alt=""/>
                        </div>
                    </Col>
                </Row>
            </ArticleHeader>
            ...
            <ContentViewer content={article ? article.description : 'afjhfsfgkhsgnkdfndksfnksfkndsfjk'}/>
            <ArticleBio/>
