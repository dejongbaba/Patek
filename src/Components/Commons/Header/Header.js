...
const Header = ({children, img, className, absRightImg, absLeftImg, extraImg, primaryLeftImg, SecondaryLeftImg,type='full'}) => {
    return (
        <header
            ...
            {absLeftImg ? <img className={'position-absolute bottom-left-5 w-50'} src={absLeftImg}/> : ''}
            ...
            {primaryLeftImg ?
                <img className={'position-absolute bottom-left-0 brigthness-0-7 -bottom-10 -right-30  w-50'} src={primaryLeftImg}/> : ''}
