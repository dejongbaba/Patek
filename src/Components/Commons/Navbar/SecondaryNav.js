...
const SecondaryNav = ({type, className}) => {
    if (type === 'blog') {
        return (
            ...
            list-unstyled position-relative secondary-nav px-lg-5 text-uppercase
             d-flex flex-column flex-lg-row mb-0 pt-lg-5`}>
                <li>
                    <NavLink activeClassName={'active'}
                             to={news}
                             className={'secondary-nav__link'}>News
                    </NavLink>
                </li>
                <li>
                    <NavLink activeClassName={'active'}
                             to={event}
                             className={'secondary-nav__link'}>Event
                    </NavLink>
                </li>
                <li>
                    <NavLink activeClassName={'active'}
                             to={blog}
                             className={'secondary-nav__link'}>Blog
                    </NavLink>
                </li>
            </ul>
        )
    ...
    return (
        <ul className={`${className ? className : ''} list-unstyled position-relative secondary-nav text-uppercase d-flex flex-column flex-lg-row mb-0 pt-lg-5`}>
            ...
            <li>
                <NavLink activeClassName={'active'} to={qualityPackaging} className={'secondary-nav__link'}>Quality Packaging</NavLink>
            </li>
            <li>
