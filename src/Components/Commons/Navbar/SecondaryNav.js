...
const SecondaryNav = ({type}) => {
    if(type==='blog'){
        return (
            <ul className='list-unstyled secondary-nav px-lg-5 text-uppercase d-flex flex-column flex-lg-row mb-0 pt-lg-5'>
    ...
    return (
            <ul className='list-unstyled secondary-nav text-uppercase d-flex flex-column flex-lg-row mb-0 pt-lg-5'>
