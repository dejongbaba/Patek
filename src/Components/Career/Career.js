        ...
        <>
            ...
            <Section className={'bg-gray-gradient-30'}>
                <Row className='pt-lg-5 text-center'>
                    <Col lg={{span: 4, offset:4}}>
                        ...
                        'hk-grotesk-regular mt-lg-5 pt-5 fs-1-5 text-black text-center'} text={'Patec Food'}/>
                    </Col>
                </Row>
                <Row className={'mt-5'}>
            ...
            <Section className={'bg-gray-gradient-30'}>
                <Row className='pt-lg-5 text-center'>
                    <Col lg={{span: 4, offset:4}}>
                        ...
                        ' mt-lg-5 pt-5 fs-1-5 text-black text-center'} text={'Colorado Farms'}/>
                    </Col>
                </Row>
                <Row className={'mt-5'}>
                    <Col lg={{span: 10,offset:1}}>
            ...
            <Section className={'bg-gray-gradient-30'}>
                <Row className='pt-lg-5 text-center'>
                    <Col lg={{span: 4, offset:4}}>
                        <HeaderText className={'border-top-green-1 d-inline-block hk-grotesk-regular' +
                        ' mt-lg-5 pt-5 fs-1-5 text-black text-center'} text={'Quality Packaging'}/>
                    </Col>
                </Row>
                <Row className={'mt-5'}>
                    <Col lg={{span: 10,offset:1}}>
